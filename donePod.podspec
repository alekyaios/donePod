...
Pod::Spec.new do |s|
  s.name             = 'donePod'
  s.version          = '0.1.0'
  s.summary          = 'A short description of donePod.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/alekyaios/donePod'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'alekyaios' => 'alekhya@krify.com' }
  s.source           = { :git => 'https://github.com/alekyaios/donePod.git', :tag => s.version.to_s }
